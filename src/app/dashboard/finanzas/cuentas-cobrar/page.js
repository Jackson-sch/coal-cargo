...
export default function CuentasPorCobrarPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Área de impresión: empresa + título + KPIs + tabla + pie */}
      <div className="print-only cxc-print-area">
        <div className="px-6">
          <div className="mb-3">
            <div className="text-sm text-muted-foreground">
              {empresaConfig?.nombre || "Empresa"}
            </div>
            <div className="text-xl font-semibold cxc-print-title">
              Cuentas por Cobrar
            </div>
          ...
          <div className="cxc-print-kpis mb-4">
            ...
            <div className="border rounded p-3">
              ...
              <div className="text-xl font-semibold">{resumen.totalEnvios}</div>
            </div>
          </div>
                ...
                {loading ? (
                  ...
                  items.map((i) => (
                    <tr key={i.id}>
                      ...
                      <td>{i.sucursalOrigenNombre}</td>
                      <td>{i.sucursalDestinoNombre}</td>
                      <td>{i.estado}</td>
                      <td>
                        {i.fechaRegistro
          ...
          <div className="cxc-print-footer">
